...
from deslib.des import DESP, DESClustering
...
des_clustering = DESClustering(pool_classifiers=pool_classifiers)
...
print('Classification accuracy of DESClustering: ', des_clustering.score(X_test, y_test))
